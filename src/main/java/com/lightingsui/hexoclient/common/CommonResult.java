...
public class CommonResult<T> {
    ...
    public static <T> CommonResult<T> getSuccessInstance(T data) {
        return getSuccessInstance(ResponseCode.OPERATE_SUCCESS, data);
    }
    ...
    public static <T> CommonResult<T> getSuccessInstance(String responseMessage, T data) {
        return new CommonResult<T>(ResponseCode.OPERATE_SUCCESS.getResponseCode(), responseMessage, data);
    }
    ...
    public static <T> CommonResult<T> getErrorInstance() {
        return getErrorInstance(ResponseCode.NORMAL_ERROR_CODE);
    }
    ...
    public static <T> CommonResult<T> getErrorInstance(String errorMessage) {
        return new CommonResult<T>(ResponseCode.NORMAL_ERROR_CODE.getResponseCode(), errorMessage, null);
    }
